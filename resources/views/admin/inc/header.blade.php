                    ...
                    <div class="dropdown-custom">
                        ...
                        <div class="dropdown-wrapper dropdown-wrapper--large">
                            <ul class="list-settings">
                                ...
                                <li class="d-flex">
                                    <div class="mr-3"><img src="{{ asset('/img/color-palette.png') }}"
                                            alt=""></div>
                                    <div class="flex-grow-1">
                                        <h6>
                                ...
                                <li class="d-flex">
                                    <div class="mr-3"><img src="{{ asset('/img/home.png') }}" alt="">
                                    </div>
                                    <div class="flex-grow-1">
                                        <h6>
                                ...
                                <li class="d-flex">
                                    <div class="mr-3"><img src="{{ asset('/img/video-camera.png') }}"
                                            alt=""></div>
                                    <div class="flex-grow-1">
                                        <h6>
                                ...
                                <li class="d-flex">
                                    <div class="mr-3"><img src="{{ asset('/img/document.png') }}" alt="">
                                    </div>
                                    <div class="flex-grow-1">
                                        <h6>
                                ...
                                <li class="d-flex">
                                    <div class="mr-3"><img src="{{ asset('/img/microphone.png') }}"
                                            alt=""></div>
                                    <div class="flex-grow-1">
                                        <h6>
